...
class Windoe (QWidget):
    def __init__ (self):
        ...
        palette.setColor(QPalette.Window, QColor(26, 44, 84))  # Remplacez par la couleur souhaitée
    ...
    def Ui(self):
        ...
        self.onlineLabel = QLabel("Utilisateur en ligne : ")
        self.onlineLabel.setStyleSheet("QFrame{\n"
        ...
        self.editor.setPlainText("Serveur...\n")
        
        self.NameEditor = QTextEdit()
        self.NameEditor.setStyleSheet("QFrame{\n"
                "background-color: rgb(26, 39, 51);\n"
                "color:rgb(255, 255, 255);\n"
                "border: 1px solid rgb(26, 39, 51) ;\n" #
                "padding: 1px;\n"
        ...
        self.botton = QPushButton("Toutes utilisateurs")
        self.botton.clicked.connect(self.getAllUser)
        self.Hbox.addWidget(self.botton,10)
        self.setStyleSheet("""
            QPushButton{
                background-color: qlineargradient(spread:pad, x1:0, y1:0.505682, x2:1, y2:0.477, stop:0 rgb(26, 39, 51));
                color:rgb(255, 255, 255);
                border-radius:5px;
            }
    ...
    def getOnlinUser(self, val):
        self.onlineLabel.setText(f"Utilisateur en ligne : {val}")
        #print(val)
